...
export default function StatsOverview({ todos }) {
  ...
  const completionPercentage = Math.round(
    (completedCount / Math.max(todos.length, 1)) * 100
  );
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
      ...
      <div className="stats bg-base-100 dark:bg-gray-800 shadow">
        <div className="stat">
          ...
          <div className="stat-desc">{completionPercentage}% of tasks</div>
        </div>
      </div>
      ...
      <div className="stats bg-base-100 dark:bg-gray-800 shadow">
        <div className="stat">
          ...
          <div
            className={`stat-desc ${
              highPriorityCount > 0 ? "text-red-400" : "dark:text-gray-400"
            }`}
          >
            {highPriorityCount > 0
